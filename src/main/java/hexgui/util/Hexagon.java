...
public final class Hexagon {
   ...
   */
  public static Polygon createVerticalHexagon(Point p, int width, int height) {
  ...
  /**
   * Creates a hexagon with flat top and bottom centered at the specified point.
   *
   * @param p center of hexagon.
   * @param width the width of the hexagon.
   * @param height the height of the hexagon.
   * @return an instance of Polygon with the above properties.
   */
  public static Polygon createHorizontalHexagon(Point p, int width, int height) {
    int xpoints[] = new int[6];
    int ypoints[] = new int[6];
